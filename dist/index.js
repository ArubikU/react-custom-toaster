...
var ToastViewport = React__namespace.forwardRef(function (_a, ref) {
    ...
    return (React__namespace.createElement(ToastPrimitives__namespace.Viewport, __assign({ ref: ref, className: cn("fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse gap-2 p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", className) }, props)));
});
ToastViewport.displayName = ToastPrimitives__namespace.Viewport.displayName;
var toastVariants = classVarianceAuthority.cva("group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-bottom-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full", {
    variants: {
        variant: {
...
var Toast = React__namespace.forwardRef(function (_a, ref) {
    ...
    return React__namespace.createElement(ToastPrimitives__namespace.Root, __assign({ ref: ref, className: cn(toastVariants({ variant: variant }), className) }, props));
});
Toast.displayName = ToastPrimitives__namespace.Root.displayName;
var ToastAction = React__namespace.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement(ToastPrimitives__namespace.Action, __assign({ ref: ref, className: cn("inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-muted/40 group-[.destructive]:hover:border-destructive/30 group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive", className) }, props)));
});
ToastAction.displayName = ToastPrimitives__namespace.Action.displayName;
var ToastClose = React__namespace.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement(ToastPrimitives__namespace.Close, __assign({ ref: ref, className: cn("absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600", className), "toast-close": "" }, props),
        React__namespace.createElement(lucideReact.X, { className: "h-4 w-4" })));
});
ToastClose.displayName = ToastPrimitives__namespace.Close.displayName;
var ToastTitle = React__namespace.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement(ToastPrimitives__namespace.Title, __assign({ ref: ref, className: cn("text-sm font-semibold", className) }, props)));
});
ToastTitle.displayName = ToastPrimitives__namespace.Title.displayName;
var ToastDescription = React__namespace.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React__namespace.createElement(ToastPrimitives__namespace.Description, __assign({ ref: ref, className: cn("text-sm opacity-90", className) }, props)));
});
...
function Toaster() {
    ...
    return (React__namespace.createElement(ToastProvider, null,
        toasts.map(function (_a) {
            ...
            return (React__namespace.createElement(Toast, __assign({ key: id }, props),
                React__namespace.createElement("div", { className: "flex items-start" },
                    icon && React__namespace.createElement("div", { className: "mr-3 mt-1" }, icon),
                    React__namespace.createElement("div", { className: "grid gap-1" },
                        title && React__namespace.createElement(ToastTitle, null, title),
                        description && React__namespace.createElement(ToastDescription, null, description))),
                action,
                React__namespace.createElement(ToastClose, null)));
        }),
        React__namespace.createElement(ToastViewport, null)));
}
